 ...
 * @version 1.0
 *
 * @section find towers near photons
 */
#ifndef GAMMALocal_H__
#define GAMMALocal_H__
...
class GammaLocal: public SubsysReco
{

  public:

    GammaLocal(const std::string &name,unsigned run,bool isHI);
    ~GammaLocal();
